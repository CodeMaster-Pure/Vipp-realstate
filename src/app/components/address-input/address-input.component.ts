      ...
      this.apiService.getZillow(data).subscribe(
        res => {
          ...
          if (res["message"]["code"] != 0) {
            ...
            const estimate = this.zillowData["value"].zestimate[0].amount[0]._ * 1;
            this.zillowData["square"] = this.commonService.commafy(this.zillowData["value"].finishedSqFt[0] * 1);
            this.zillowData["built_year"] = this.zillowData["value"].yearBuilt[0];
